...
public class PublicTravelNoteController {
	...
	public @ResponseBody AjaxObj upload(MultipartFile attach,String pictype,HttpServletResponse resp) throws IOException{
...
/*		resp.setContentType("text/plain;charset=utf-8");
	...
	public @ResponseBody AjaxObject addTextNote(Note note){
		AjaxObject ao = null;
		try {
